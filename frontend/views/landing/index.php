...
<?php $this->beginBlock('loginForm'); ?>
    ...
    <?= $form->field($model, 'email', ['labelOptions' => ['class' => 'form-modal-description'], 'errorOptions' => ['tag' => 'span', 'style' => 'margin-bottom: 35px; color: red;']])
        ->textInput(['class' => 'enter-form-email input input-middle', 'style' => 'margin-bottom: 0;']) ?>
    <?= $form->field($model, 'password', ['labelOptions' => ['class' => 'form-modal-description'], 'errorOptions' => ['tag' => 'span', 'style' => 'margin-bottom: 35px; color: red;']])
        ->passwordInput(['class' => 'enter-form-email input input-middle', 'style' => 'margin-bottom: 0;']) ?>
